...
public class Def {
	public static final String dbUrl ="jdbc:mysql://localhost:3306/apt_priserdv"; //= "jdbc:mysql://hnv.hnv-tech.com:3306/test";
	public static final String dbUsername = "root";//"web101010";
